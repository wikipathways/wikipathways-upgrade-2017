...
class PagePuller {
	...
	private static function trimBrackets( $page ) {
	...
	public function getPageList() {
		...
		if ( $content !== false ) {
			$this->pageList = array_map( [ __CLASS__, "trimBrackets" ],
				explode( "\n", $content ) );
	...
	public function savePage( $page, $content ) {
		...
		global $wgOut;
		if ( $wgOut->mRedirect !== null ) { /* Otherwise we end up on the last page successfully imported */			$wgOut->mRedirect = null;
			return true;
		}
		return false;
	}
